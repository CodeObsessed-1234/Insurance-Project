      ...
      if (choice == 1) {
        while (true) {
          if (adminLogin || adminNewCreated) {
            ...
            System.out.println("4 for FetchAllUsers");
            System.out.println("5 for Deleting User's Details and Policy");
            ...
            if (choice == 1) {
              ...
              policyId = Admin.getLastIdOfPolicy(policyFile);
              ...
              Admin.fetchAllUsers(fileUser, userPolicies);
            } else if (choice == 5) {
              System.out.println("Enter Name of User = ");
              name = new StringBuilder(sc.next());
              Admin.deleteUserDetailsAndPolicy(fileUser, userPolicies, name);
            } else if (choice == -1) {
